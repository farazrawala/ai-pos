...
import QuickAddAttributeModal from '../attribute/QuickAddAttributeModal.jsx';
...
export default function ProductVariationsModal({
  ...
  const { canCreate: canCreateAttribute } = usePermissions('attributes');
  const [showQuickAddAttribute, setShowQuickAddAttribute] = useState(false);
  ...
  const handleAttributeCreated = (created) => {
    ...
    setShowQuickAddAttribute(false);
  };
  ...
  return (
    <>
                ...
                <div className="pv-empty">
                  ...
                  {canCreateAttribute ? (
                    ...
                    <p className="text-sm text-muted mb-0">
                      You don’t have permission to create attributes.
                    </p>
                  )}
                </div>
              ) : (
      ...
      <QuickAddAttributeModal
        open={open && showQuickAddAttribute}
        onClose={() => setShowQuickAddAttribute(false)}
