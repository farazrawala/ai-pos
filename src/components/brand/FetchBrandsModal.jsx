...
export default function FetchBrandsModal({ open, onClose, onSaved }) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setSaveError(err?.message || 'Failed to queue brand sync process');
    }
  };
  ...
  return (
    <>
      <div
        ...
        tabIndex={-1}
        role="dialog"
        aria-labelledby="fetchBrandsModalLabel"
        aria-modal="true"
      >
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="fetchBrandsModalLabel">
                Fetch Brands
              </h5>
              <button
                type="button"
            ...
            <div className="modal-body">
              <p className="text-sm text-muted mb-3">
                Select a store integration to import brands from WooCommerce or another connected
                platform.
              </p>
              ...
              {integrationsStatus === 'succeeded' && integrations.length > 0 && (
                <div className="mb-0">
                  <label htmlFor="fetchBrandsIntegration" className="form-label">
                    Integration <span className="text-danger">*</span>
                  </label>
                  <select
                    id="fetchBrandsIntegration"
