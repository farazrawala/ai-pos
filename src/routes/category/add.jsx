        ...
        <div className="cat-form-card card">
          <div className="cat-form-header">
            <div>
              ...
              <h5 className="cat-form-title">Add new category</h5>
              <p className="cat-form-subtitle">Create a new category for your products.</p>
            </div>
            <button
              type="button"
                  ...
                  {imagePreview ? (
                    <>
                      <div className="cat-image-preview-wrap">
                        <span className="cat-image-badge">Selected</span>
                        <img src={imagePreview} alt="Selected category" />
                      </div>
