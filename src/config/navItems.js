...
export const NAV_ITEMS = [
  ...
  },
  {
    ...
    children: [
      ...
      { to: '/low-stock-alerts', label: 'Low stock alerts', icon: FaTriangleExclamation },
  ...
  },
  {
    ...
    icon: FaGamepad,
    children: [
      { to: '/games', label: 'Games Hub', icon: FaGamepad, end: true },
      { to: '/games/snake', label: 'Snake', icon: FaStaffSnake },
      { to: '/games/2048', label: '2048', icon: FaTableCellsLarge },
      { to: '/games/tetris', label: 'Tetris', icon: FaShapes },
      { to: '/games/memory', label: 'Memory', icon: FaBrain },
      { to: '/games/tic-tac-toe', label: 'Tic-Tac-Toe', icon: FaHashtag },
    ],
  },
  {
    id: 'developer-tools',
